...
class Job(models.Model):
    ...
    one_up_width = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    one_up_height = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    print_sheet_width = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    print_sheet_height = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    print_sheet_size = models.CharField(max_length=50, blank=True, null=True)
    ups = models.PositiveIntegerField(blank=True, null=True)
    purchase_sheet_width = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    purchase_sheet_height = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    ...
    def __str__(self):
        return f"{self.job_name} - {self.sku_code}"
